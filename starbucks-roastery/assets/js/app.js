$(document).ready(function() {
  ...
  $('#tip-1').on('click', function() {
    ...
    if (!tipOneVisited) {
      ...
      xapistatement('viewed','http://virtual-reality-seattle.com/starbucks-roastery/1','fact 1','in Starbucks Roastery');
  ...
  $('#tip-2').on('click', function() {
    ...
    if (!tipTwoVisited) {
      ...
      xapistatement('viewed','http://virtual-reality-seattle.com/starbucks-roastery/2','fact 2','in Starbucks Roastery');
